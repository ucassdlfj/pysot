...
# for detail discussion, wether is too comflict.
__C.DATASET.TEMPLATE.SHIFT = 4
# SCALE means random change scale changes of crop location
...
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat, video or pair.
...
# Scale penalty, validation for different scales.
